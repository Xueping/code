...
<jsp:include page="/leftAndTop.jsp" />
    ...
    <div class="wrapper">
			<!-- Form -->
			<form class="form" action="addAlgorithm.action" method="post" enctype="multipart/form-data">
				<fieldset>
					<div class="widget">
						<div class="title">
						...
						<div class="formRow">
							...
							<div class="formRight">
								<input type="text" name="algorithm.alg_price" value="$">
							</div>
						</div>
					    <div class="formRow">
							<label>Upload Picture:</label>
							<div class="formRight">
								<input type="file" name="alg_picture_file" id="alg_picture_file"/>
							</div>
						</div>
						 <div class="formRow">
							<label>Upload Files:</label>
							<div class="formRight">
								<input type="file" name="alg_related_file" id="alg_related_file"/>
							</div>
						</div>
						<div class="formRow">
							<label>Upload Codes:</label>
							<div class="formRight">
								<input type="file" name="alg_code_file" id="alg_code_file"/>
							</div>
						</div>
						<div class="formRow">
						...
						<div class="formRow">
	                        ...
	                        <div class="formRight">
	                            <input type="checkbox" name="algorithm.copyright" value="true" id="algorithm.copyright"/> Please read the terms of service!
	                        </div>
	                    </div>
