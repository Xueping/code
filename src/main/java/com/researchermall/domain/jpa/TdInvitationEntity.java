/*
 * Created on 1 May 2014 ( Time 10:13:30 )
...
@NamedQueries ( {
  @NamedQuery ( name="TdInvitationEntity.countAll", query="SELECT COUNT(x) FROM TdInvitationEntity x" )
} )
public class TdInvitationEntity implements Serializable {
