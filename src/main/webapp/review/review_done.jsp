...
<title>Algorithm Review Done</title>
				...
				<fieldset>
					<div class="widget">
						...
						<s:if test="admin==true">
							<form action="review_done_submit.action" method="get">
							...
							<div class="formRow">
								...
								<div class="formRight">
									<s:select list="adminResultList"  name="adminResult" id="adminResult" value="algorithm.review_result"></s:select>
								</div>
							</div>
