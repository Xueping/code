/*
 * Created on 1 May 2014 ( Time 10:13:46 )
...
@NamedQueries ( {
  @NamedQuery ( name="TdUserEntity.countAll", query="SELECT COUNT(x) FROM TdUserEntity x" )
} )
public class TdUserEntity implements Serializable {
