				...
				<fieldset>
					<div class="widget">
						...
						<s:iterator value="reviews">
							...
							<s:if test="status=='Ongoing'">
							<form action="review_delete.action" method="post">
								<input type="hidden" name="alg_id" value="<s:property value="algorithm.alg_ID"/>">
								<input type="hidden" name="review_id" value="<s:property value="id"/>">
								<input type="hidden" name="username" value="<s:property value="user.username"/>">
								<div class="formSubmit">
									<input class="redB" type="submit" value="Delete">
								</div>
							</form>
							</s:if>
						</s:iterator>
						...
						<div class="line"></div>
						<div class="title"><h6>Re-assign Reviewers:</h6></div>
						<div class="line"></div>
