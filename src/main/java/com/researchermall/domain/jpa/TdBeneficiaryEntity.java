/*
 * Created on 1 May 2014 ( Time 10:13:14 )
...
@NamedQueries ( {
  @NamedQuery ( name="TdBeneficiaryEntity.countAll", query="SELECT COUNT(x) FROM TdBeneficiaryEntity x" )
} )
public class TdBeneficiaryEntity implements Serializable {
